...
import OndulatóriaHome from "./pages/OndulatoriaHome";
import OndulatóriaTopicConceitos from "./pages/OndulatoriaTopicConceitos";
import OndulatóriaTopicMHS from "./pages/OndulatoriaTopicMHS";
import OndulatóriaTopicEquacao from "./pages/OndulatoriaTopicEquacao";
import OndulatóriaTopicFenomenos from "./pages/OndulatoriaTopicFenomenos";
import OndulatóriaTopicSom from "./pages/OndulatoriaTopicSom";
import OndulatóriaTopicLuz from "./pages/OndulatoriaTopicLuz";
